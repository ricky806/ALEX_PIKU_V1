...
break
            ...
            break
            case 'checkdeath':
             if (!text) return replay(`Use Someone's Name, Example : ${prefix + command} Anjan`)
...
│ 𓆩‎✘ㄖ山几乇尺✘𓆪: ${ownername}
│ 𓆩‎✘ᐯ乇尺丂丨ㄖ几✘𓆪: ${mver}
│ 𓆩‎✘卄ㄖ丂ㄒ✘𓆪: ${os.hostname()}
│ 𓆩‎✘卩ㄥ卂ㄒ乇千ㄖ尺爪✘𓆪: ${os.platform()} 
│ 𓆩‎✘尺ㄩ几ㄒ丨爪乇✘𓆪: ${runtime(process.uptime())}
│ 𓆩‎✘ㄒㄖㄒ卂ㄥ匚爪ᗪ✘𓆪: ${mariafeature()}
╰────────────┈
${readmore}
┌──⊰ _*GENERAL*_
│⊳  ${prefix}hi
